...
module.exports = {
  ...
  module: {
    ...
    {
      test: /\.scss$/,
      loader: "style-loader!css-loader!sass-loader?includePaths[]=" + Path.resolve(__dirname, "./node_modules/compass-mixins/lib") + "&includePaths[]=" + Path.resolve(__dirname, "./mixins/app_mixins")
    },
